...
// Step 1. Match the conv_2d operation.
  %conv2d = transform.structured.match ops{["linalg.conv_2d"]} in %arg0 : (!transform.any_op) -> !transform.any_op

// Step 2. Tile the conv_2d operation using forall.
  ...
  // Apply some common patterns to the function.
  ...
  // Further tile the operation inside the forall loop.
  ...
  // Apply padding to the tiled operation.
  ...
  // Rewrite in destination passing style.
  ...
  // Tile again using forall and map to GPU threads.
  ...
  %all_loops_2 = transform.structured.match interface{LoopLikeInterface} in %14 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_3 = transform.structured.match interface{LoopLikeInterface} in %16 : (!transform.any_op) -> !transform.any_op
  ...
  // Apply final patterns and transformations.
  ...
  %all_loops_4 = transform.structured.match interface{LoopLikeInterface} in %17 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_5 = transform.structured.match interface{LoopLikeInterface} in %21 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_6 = transform.structured.match interface{LoopLikeInterface} in %23 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_7 = transform.structured.match interface{LoopLikeInterface} in %24 : (!transform.any_op) -> !transform.any_op
  ...
  transform.apply_cse to %24 : !transform.any_op
  %all_loops_8 = transform.structured.match interface{LoopLikeInterface} in %24 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_9 = transform.structured.match interface{LoopLikeInterface} in %24 : (!transform.any_op) -> !transform.any_op
  ...
  %all_loops_10 = transform.structured.match interface{LoopLikeInterface} in %24 : (!transform.any_op) -> !transform.any_op
